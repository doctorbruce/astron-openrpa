...
export const IPC_OPENCODE_RENAME_SESSION = "opencode:renameSession"
export const IPC_OPENCODE_DELETE_SESSION = "opencode:deleteSession"
export const IPC_OPENCODE_ABORT_SESSION = "opencode:abortSession"
...
export const IPC_OPENCODE_GET_SESSION_MODEL_SELECTION = "opencode:getSessionModelSelection"
export const IPC_OPENCODE_SAVE_SESSION_MODEL_OVERRIDE = "opencode:saveSessionModelOverride"
export const IPC_OPENCODE_CLEAR_SESSION_MODEL_OVERRIDE = "opencode:clearSessionModelOverride"
export const IPC_OPENCODE_LIST_MCP_STATUS = "opencode:listMcpStatus"
export const IPC_OPENCODE_SAVE_MCP_SERVER = "opencode:saveMcpServer"
export const IPC_OPENCODE_DELETE_MCP_SERVER = "opencode:deleteMcpServer"
export const IPC_OPENCODE_CONNECT_MCP_SERVER = "opencode:connectMcpServer"
export const IPC_OPENCODE_DISCONNECT_MCP_SERVER = "opencode:disconnectMcpServer"
...
export const IPC_OPENCODE_PICK_WORKSPACE = "opencode:pickWorkspace"
export const IPC_OPENCODE_IMPORT_SKILL = "opencode:importSkill"
export const IPC_OPENCODE_DELETE_SKILL = "opencode:deleteSkill"
